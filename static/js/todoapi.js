function displayTodos()
{
    $.ajax( {
        ...
        success: function ( result )
        {
            ...
            {
                document.getElementById( "todos" ).innerHTML += `\n<div class="todo-item" id="div-${result[key].todoId}" ><label id="lbl-${result[key].todoId}" onclick="editTask(this)">${result[key].task}</label><button id="${result[key].todoId}" class="btn" onclick="deleteTask(this)">remove</button></div>\n`
            }
        },
...
function addTask()
{
    ...
    ele.innerHTML = `\n<div class="todo-item" id="div-${data.todoId}" ><label id="lbl-${data.todoId}" onclick="editTask(this)">${data.task}</label><button id="${data.todoId}" class="btn" onclick="deleteTask(this)">remove</button></div>\n` + ele.innerHTML;
